...
| 阅读级别 | 论文 | 后续单篇笔记位置 | 读法 |
| --- | --- | --- | --- |
| 精读 | Allman, Matias & Rhodes (2009). Identifiability of parameters in latent structure models with many observed variables. | [完整专题](papers/allman-2009/index.md) | CDM 识别理论的上游。重点读 three-block 分解、Kruskal 条件和 generic identifiability 的表达方式。 |
