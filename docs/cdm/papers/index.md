...
| [Q 矩阵验证与学习](categories/q-matrix.md) | 14 | 3 | de la Torre (2008)、de la Torre & Chiu (2016)、Liu et al. (2012) 已完成首版 |
...
9. Liu, Xu and Ying (2013)：自学习 Q 矩阵理论（下一篇）；
10. 高维估计、正则化和结构学习；
11. partial mastery、continuous-Q 和 general-response 扩展；
12. HMM、随机图与机器学习背景；
13. 其余混合模型和识别理论来源。
